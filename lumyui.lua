if (game:GetService("CoreGui")):FindFirstChild("LumyHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).LumyHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 120, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(70, 255, 70);
...
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("LumyHub")).Enabled = not (game.CoreGui:FindFirstChild("LumyHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("LumyHub") then
			makefolder("LumyHub");
		end;
		if not isfolder("LumyHub/Library/") then
			makefolder("LumyHub/Library/");
		end;
		if not isfile(("LumyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("LumyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("LumyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("LumyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("LumyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local LumyHub = Instance.new("ScreenGui");
	LumyHub.Name = "LumyHub";
	LumyHub.Parent = game.CoreGui;
	LumyHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = LumyHub;
	OutlineMain.ClipsDescendants = true;
	OutlineMain.AnchorPoint = Vector2.new(0.5, 0.5);
	OutlineMain.BackgroundColor3 = Color3.fromRGB(30, 70, 30);
